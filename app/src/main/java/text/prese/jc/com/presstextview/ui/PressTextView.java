package text.prese.jc.com.presstextview.ui;
...
import text.prese.jc.com.presstextview.R;
...
public class PressTextView extends TextView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //------------背景颜色
        // 按下背景颜色
        mPressTextConfig.mPressBackgroundColor = typedArray.getColor(R.styleable.PressTextView_PressBackgroundColor, 0xff3F51B5);
        // 正常情况下背景颜色
        mPressTextConfig.mNormalBackgroundColor = typedArray.getColor(R.styleable.PressTextView_NormalBackgroundColor, 0xff303F9F);
        // 禁用情况下背景颜色
        mPressTextConfig.mDisableBackgroundColor = typedArray.getColor(R.styleable.PressTextView_DisableBackgroundColor, 0xffe6e6e6);
        // 选中状态下背景颜色
        mPressTextConfig.mSelectBackgroundColor = typedArray.getColor(R.styleable.PressTextView_SelectBackgroundColor, 0xffFF4081);
        //------------背景颜色
        ...
        // 禁用情况下字体颜色
        mPressTextConfig.mDisableTextColor = typedArray.getColor(R.styleable.PressTextView_DisableTextColor, 0xff999999);
        // 选中情况下字体颜色
